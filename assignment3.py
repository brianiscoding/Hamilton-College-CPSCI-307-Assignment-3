...
class TranslationModel(pl.LightningModule):
    ...
    def calculate_bleu(self, preds, targets):
        ...
        return self.bleu_metric(
            preds, targets
        )  # Use the BLEUScore metric from torchmetrics
...
model = TranslationModel(
    vocab_size_src, vocab_size_tgt, emb_size, num_heads, num_layers
)
...
trainer = pl.Trainer(
    ...
    accelerator="gpu",  # Specify the use of GPU (use "cpu" if not using GPU)
